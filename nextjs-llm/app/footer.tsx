...
import { saveApiKey } from '../appUtils/utils';
...
const Footer = () => {
	...
	return (
		<footer className='py-4 bg-gray-800 fixed bottom-0 w-screen'>
			<div className='max-w-screen-xl px-4 md:px-8'>
				{/* <div className='justify-between items-center gap-12 md:flex'>
					...
					<div className='flex-1 mt-6 md:mt-0'>
						<form
							...
							className='py-4 flex items-center gap-x-3 md:justify-end'
						>
							<div className='relative'>
								...
								<input
									...
									ref={(ref) => apiRef}
									required
									aria-placeholder='Enter your OpenAI API Key here'
									placeholder='Enter Key'
									className='w-full pl-12 pr-3 py-2 text-gray-500 bg-white outline-none border focus:border-indigo-600 shadow-sm rounded-lg'
								/>
							</div>
							<button
								onClick={() => saveApiKey(apiRef?.current || '')}
				...
				<div className='border-t border-gray-700 items-center justify-between sm:flex'>
					{/* <p className='text-gray-300'>© 2023 Created by Vance Denson. All rights reserved.</p> */}
